<template>
    <div
        class="flex flex-row border bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-900 p-4 rounded overflow-hidden"
    >
        <div
        ...
        >
            <div
                v-if="icon"
                class="aspect-square h-full bg-gray-100 rounded hidden md:flex items-center justify-center dark:bg-gray-700"
            >
                <i
                    :class="`fa-solid ${icon} text-xl text-gray-500 dark:text-gray-400`"
                ></i>
            </div>
            <div
                v-else-if="svgIcon"
