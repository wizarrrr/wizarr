...
const steps = (__: (key: string) => string): TourGuideStep[] => [
    {
        ...
        content: __(
            'We want to help you get started with Wizarr as quickly as possible, consider following this tour to get a quick overview.',
        ),
    },
    {
        title: __('Dashboard Widgets'),
        content: __(
            'These are your widgets, you can use them to get a quick overview of your Wizarr instance.',
        ),
    ...
    },
    {
        ...
        content: __(
            'Like this Widget, it shows you the latest information about Wizarr and will be updated regularly by our amazing team.',
        ),
        target: '.latest-info',
    },
    {
        ...
        content: __(
            'You can also edit your dashboard, delete widgets, add new widgets, and move them around.',
        ),
...
const options = (
    ...
    app?: App,
): Partial<CustomTourGuideOptions> => {
    return {
