...
const steps = (__: (key: string) => string): CustomTourGuideStep[] => [
    {
        ...
        content: __(
            'This is where you can manage your invitations, they will appear here in a list. Invitations are used to invite new users to your media server.',
        ),
        target:
            document.querySelector('#invitationList > li:nth-child(1)') ??
            '#invitationList',
    },
    {
        title: __('Create Invitation'),
        content: __(
            "You can create a new invitation by clicking on the 'Create Invitation' button.",
        ),
