<template>
    <div
        class="flex flex-wrap items-start md:items-center justify-center mx-auto mt-20 md:mt-0 md:h-screen"
    >
        ...
        >
            <div
                class="w-full rounded md:mt-0 sm:max-w-md xl:p-0 md:shadow dark:bg-transparent md:bg-white md:dark:border md:dark:border-gray-700"
            >
...
export default defineComponent({
    ...
    async mounted() {
        ...
        const browserSupportsWebAuthnAutofill =
            await this.auth.browserSupportsWebAuthnAutofill();
