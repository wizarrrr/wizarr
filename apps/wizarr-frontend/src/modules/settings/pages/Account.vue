<template>
    <div class="flex flex-col">
        <span
            class="border border-yellow-500 rounded p-2 text-yellow-500 text-xs text-center"
            >{{ __('This page is currently read only!') }}</span
        >
        <br />
        <FormKit
            type="form"
        ...
        >
            ...
            <FormKit
                ...
                :value="user?.email"
                :label="__('Email')"
                :placeholder="__('marvin@wizarr.dev')"
            />
        </FormKit>
    </div>
</template>
