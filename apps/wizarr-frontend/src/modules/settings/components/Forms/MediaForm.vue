    ...
    <div>
        ...
        >
            ...
            <FormKit
                ...
                placeholder="https://plex.wizarr.dev"
                @button="detectServer"
                autocomplete="url"
            >
                {{ __('Detect Server') }}
        ...
        <div class="flex flex-col sm:flex-row">
            <div
                class="flex flex-grow justify-end sm:justify-start space-x-2 mt-2"
            >
                <!-- Scan Libraries -->
                <FormKit
                    type="button"
            ...
            <div
                class="flex flex-grow justify-end sm:justify-end space-x-2 mt-2"
            >
                <!-- Verify Server -->
                <FormKit
                    type="button"
                    v-if="!verified"
                    :disabled="
                        !serverForm.server_type || !serverForm.server_api_key
                    "
