...
api = Namespace("Jellyfin", description="Jellyfin related operations", path="/jellyfin")

@socketio.on("connect", namespace="/jellyfin")
def connect():
    print("Client connected")

@api.route("")
@api.route("/", doc=False)
class JellyfinStream(Resource):
    """Listen for Jellyfin authentication events"""
    ...
    def post(self):
        ...
        join_room(random_id, sid=socket_id, namespace="/jellyfin")
