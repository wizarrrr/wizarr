...
describe("Module", function () {
    ...
    it("logs a warning if the forwardUrl does not use http/https protocol", function () {
        var testError = new src_1.PlexOauth({
            clientIdentifier: "dhjoasoidjapoiwdmamlw",
            device: "TEST DEVICE",
            product: "TEST DEVICE",
            version: "1",
    ...
    it("returns a URL with no forwardUrl if the input forwardUrl is not specified", function () { return __awaiter(void 0, void 0, void 0, function () {
        var details, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new src_1.PlexOauth({
                        clientIdentifier: "dhjoasoidjapoiwdmamlw",
                        device: "TEST DEVICE",
                        product: "TEST DEVICE",
                        version: "1"
                ...
                case 1:
                    details = _a.sent();
                    url = new URL(details[0]);
                    expect(url.hash).not.toMatch(/\&forwardUrl=(.*)/);
                    return [2 /*return*/];
            }
        });
    }); });
    it("returns a URL with forwardUrl if the input forwardUrl is specified", function () { return __awaiter(void 0, void 0, void 0, function () {
        var details, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new src_1.PlexOauth({
