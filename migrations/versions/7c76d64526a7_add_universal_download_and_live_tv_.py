...
def upgrade():
    ...
    with op.batch_alter_table("media_server", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("allow_downloads", sa.Boolean(), nullable=False, default=False)
        )
        batch_op.add_column(
            sa.Column("allow_live_tv", sa.Boolean(), nullable=False, default=False)
        )
        batch_op.add_column(
            sa.Column(
                "allow_downloads_emby", sa.Boolean(), nullable=False, default=False
            )
        )
        batch_op.add_column(
            sa.Column("allow_tv_emby", sa.Boolean(), nullable=False, default=False)
        )
...
def downgrade():
    ...
    with op.batch_alter_table("media_server", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "allow_downloads_plex", sa.Boolean(), nullable=False, default=False
            )
        )
        batch_op.add_column(
            sa.Column("allow_tv_plex", sa.Boolean(), nullable=False, default=False)
        )
        batch_op.add_column(
            sa.Column(
                "allow_downloads_jellyfin", sa.Boolean(), nullable=False, default=False
            )
        )
        batch_op.add_column(
            sa.Column("allow_tv_jellyfin", sa.Boolean(), nullable=False, default=False)
        )
