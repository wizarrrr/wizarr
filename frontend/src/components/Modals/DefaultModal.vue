        ...
        <div class="relative z-30" v-if="visible">
            ...
            <div class="fixed inset-0 z-10 md:overflow-y-auto">
                <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="flex flex-col fixed top-0 bottom-0 left-0 right-0 h-full w-full md:h-auto md:w-auto transform overflow-hidden text-left shadow-xl transition-all md:relative md:min-w-[30%] md:max-w-2xl md:shadow-none md:transform-none sm:align-middle rounded text-gray-900 dark:text-white">
                        <!-- Modal header -->
                        ...
                        <div v-else-if="titleString" class="flex items-center bg-white pl-6 p-3 dark:bg-gray-800 justify-between p-4 border-b dark:border-gray-600">
                        ...
                        <!-- Modal footer -->
                        <div v-if="footerSlotAvailable" class="flex items-center justify-end bg-white p-6 dark:bg-gray-800 p-6 space-x-2 border-t border-gray-200 dark:border-gray-600">
                            <slot name="footer"></slot>
                            <DefaultButton @click="close()" v-if="showCloseButton">
                                {{ closeButtonText }}
                            </DefaultButton>
                        </div>
                        <div v-else-if="footer" class="flex items-center justify-end bg-white p-6 dark:bg-gray-800 p-6 space-x-2 border-t border-gray-200 dark:border-gray-600">
