...
const initialElements = [
    // Nodes
    { id: "1", label: "This page is still under testing", position: { x: 400, y: 100 }, class: "light" },
    { id: "2", label: "there is currently not functionality", position: { x: 400, y: 300 }, class: "light" },
