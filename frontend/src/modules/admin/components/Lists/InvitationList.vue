<template>
    <Draggable :disabled="isDisabled" v-if="invitations && invitations.length > 0" v-model="invitations" tag="ul" group="invites" ghost-class="moving-card" :animation="200" item-key="id">
...
import InvitationItem from "../ListItems/InvitationItem.vue";
